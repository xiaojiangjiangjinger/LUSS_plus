...
parser.add_argument("--pretrained", type=str, default="/mnt/PASS-jittor/weights/pass50/pixel_attention/checkpoint.pth.tar",
                    help="the model checkpoint")
parser.add_argument("--data_path", type=str, default="/data/ImageNet-S/ImageNetS50", help="path to data")
parser.add_argument("--dump_path", type=str, default="/mnt/PASS-jittor/weights/pass50/pixel_attention",
