...
def parse_args():
    ...
    parser.add_argument('--dump_path',
                        type=str,
                        default="./weights/pass50/pixel_finetuning",
                        help='The path to save results.')
    parser.add_argument('--match_file',
                        type=str,
                        default="./weights/pass50/pixel_finetuning/validation/match.json",
    ...
    parser.add_argument('--pretrained',
                        type=str,
                        default="./weights/pass50/pixel_finetuning/checkpoint.pth.tar",
...
def main_worker(args):
    ...
    data_path = os.path.join(args.data_path, args.mode +'B')
