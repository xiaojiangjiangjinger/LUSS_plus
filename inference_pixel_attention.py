...
def parse_args():
    ...
    parser.add_argument("--dump_path", type=str, default="./weights/pass50/pixel_attention", help="The path to save results.")
    parser.add_argument("--data_path", type=str, default="/data/ImageNet-S/ImageNetS50", help="The path to ImagenetS dataset.")
    parser.add_argument("--pretrained", type=str, default="./weights/pass50/pixel_attention/checkpoint.pth.tar", help="The model checkpoint file.")
    ...
    parser.add_argument("--centroid", type=str, default="./weights/pass50/pixel_attention/cluster/centroids.npy", help="The centroids of clustering.")
